...
class _AddExpenseState extends ConsumerState<AddExpense> {
  ...
  List<Map<String, dynamic>> _addExpense = [];

  void _refreshAddExpense() async {
  ...
  void initState() {
    super.initState();
    _refreshAddExpense();
    print("..number of items ${_addExpense.length + 1}");
  }
  ...
  Future<void> _addItem() async {
    ...
    _refreshAddExpense();
    print("..number of items ${_addExpense.length}");
    print(_addExpense);
  }
  ...
  void _showForm(int? id) async {
    if (id != null) {
      final existingAddExpense =
          _addExpense.firstWhere((element) => element['id'] == id);
      _incomeSourceController.text = existingAddExpense['source_of_income'];
      _addAmountController.text = existingAddExpense['add_amount'];
      _addDateController.text = existingAddExpense['add_amount_date_time'];
    }
          ...
          child: Column(
            children: [
              ...
              ListView.builder(
                  ...
                  itemCount: _addExpense.length,
                  itemBuilder: (context, index) => InkWell(
                        onTap: () => _showForm(_addExpense[index]['id']),
                        child: Card(
                            ...
                            children: [
                              Padding(
                                ...
                                child: SizedBox(
                                  width: 80,
                                  child: Text(
                                    _addExpense[index]['source_of_income'],
                                    softWrap: true,
                              ...
                              Expanded(
                                ...
                                child: IconButton(
                                    onPressed: () =>
                                        _showForm(_addExpense[index]['id']),
